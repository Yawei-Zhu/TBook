 ...
 * 浣跨敤sqlite绱㈠紩瀹炵幇鐨凩ruDiskCache
 */
public final class LruDiskCache {

    private static final HashMap<String, LruDiskCache> DISK_CACHE_MAP = new HashMap<String, LruDiskCache>(5);

    private static final int LIMIT_COUNT = 5000; // 闄愬埗鏈�5000鏉℃暟鎹�    
    private static final long LIMIT_SIZE = 1024L * 1024L * 100L; // 闄愬埗鏈�100M鏂囦欢
